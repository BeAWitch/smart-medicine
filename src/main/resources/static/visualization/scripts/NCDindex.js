...
function init(){
  ...
  mapChart.setOption({
      ...
      series: [{
          ...
          data: [
            [118.096435, 24.485408, '沈阳市'] ,
            [118.094564, 24.457358, '东北国际医院'] ,
            [118.104103, 24.477761, '沈阳中山医院'],
            [118.14748, 24.506295, '沈阳中医院'],
            [118.254841, 24.665349, '沈阳第五医院'],
           ]
      }]
  });
    ...
    lineChart.setOption({
      ...
      legend: {
          ...
          textStyle : {
           ...
           data : ['东北国际医院','沈阳中山医院','沈阳中医院','沈阳第五医院',],
      },
      calculable : false,
      tooltip : {
          trigger: 'item',
