...
function init() {
        ...
        series: [
            {
                ...
                data: [
                    {value: 335, name: '东北国际医院'},
                    {value: 310, name: '沈阳中山医院'},
                    {value: 234, name: '沈阳中医院'},
                    {value: 135, name: '沈阳第五医院'}
    ...
    fetch('/history/data', {
        ...
        echarts.init(document.getElementById('lineChart2')).setOption(option)
    })
}
